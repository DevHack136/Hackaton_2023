        ...
        <section id="accueil">
            <div className="accueilDiv">
                ...
                <p className="">
                    ...
                    <strong>1. Orientation professionnelle personnalisée :</strong>
                    <br />
                    Notre équipe de conseillers professionnels vous accompagnera dans l'exploration des métiers, la découverte de vos aptitudes et la définition de vos objectifs professionnels.
                    <br />
                    Nous vous aiderons à trouver la voie qui correspond le mieux à vos intérêts et compétences.
                    
                    <br />
                    <br />

                    <strong>2. Accès aux formations :</strong>
                    <br />
                    Nous vous donnerons accès à une liste complète de formations professionnelles adaptées à vos besoins et à vos ambitions.
                    <br />
                    Nous vous aiderons également à préparer votre candidature et à trouver les financements nécessaires pour vous former.
                    
                    <br />
                    <br />
                    
                    <strong>3. Mise en relation avec les employeurs :</strong>
                    <br />
                    Nous avons établi un réseau solide de partenaires professionnels locaux.
                    <br />
                    Nous faciliterons votre mise en relation avec les entreprises qui recrutent et nous vous soutiendrons tout au long du processus de recherche d'emploi.
                    
                    <br />
                    <br />

                    <strong>4. Soutien social et administratif :</strong>
                    <br />
